...
@section('content')
<div class="clever-catagory blog-details bg-img d-flex align-items-center justify-content-center p-3 height-400" style="background-image: url({{ asset($data_sampah->getThumbnail()) }});">
    <div class="blog-details-headline">
        <h3>{{ $data_sampah->judul }}</h3>
    </div>
</div>
<!-- ##### Catagory Area End ##### -->
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="blog-details-text">
                    <p>nama sampah : {!! $data_sampah->judul !!}</p>
                    <p>jenis sampah : {!! $data_sampah->jenis !!}</p>
                    <p>harga : {!! $data_sampah->harga !!}</p>
                    <p>deskripsi : {!! $data_sampah->deskripsi !!}</p>
