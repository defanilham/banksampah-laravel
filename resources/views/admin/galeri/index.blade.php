        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <tr>
                  ...
                  <td>
                    <div class="row ml-2">
                        <a href="{{ route('admin.galeri.edit',$agd->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>

                        <form method="POST" action="{{ route('admin.galeri.destroy',$agd->id) }}">
                            @csrf
                            @method('DELETE')
